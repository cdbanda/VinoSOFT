<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="RegistracionNewsletter.aspx.cs" Inherits="VinoSOFT.RegistracionNewsletter" %>
...
<%--                                    <asp:ListItem Value="Todos">Seleccionar Todo</asp:ListItem>--%>
                    ...
                    <%--<asp:HiddenField id="checkCaptcha" runat="server" ClientIDMode="Static"/>

                     <div class="form-group">
                        <div class="col-sm-9 col-sm-offset-2">
                            <div class="g-recaptcha" data-callback="recaptchaCallback" data-sitekey="6LdExrkUAAAAADfeIIkKIwktHXM83vNyorQSUWRE"></div>
                        </div>
                    </div>--%>
